...
public class PuzzleBoard5 {
    ...
    private PuzzleBoard5 previousBoard;
    private int steps;


    PuzzleBoard5(Bitmap bitmap, int parentWidth){
    ...
    PuzzleBoard5(PuzzleBoard5 otherBoard){
    ...
    public boolean equals(Object obj) {
        ...
        return tiles.equals(((PuzzleBoard5)obj).tiles );
    }
    ...
    public ArrayList<PuzzleBoard5> neighbours() {

        ArrayList<PuzzleBoard5> neighbours = new ArrayList<>();
        ...
        for (int [] delta: NEIGHBOUR_COORDS) {
            ...
            if (tileX < NUM_TILES && tileX >= 0 && tileY < NUM_TILES && tileY >= 0){
                ...
                PuzzleBoard5 temp = new PuzzleBoard5(this);
