...
public class PuzzleImageGame5x5 extends Activity {

    static final int IMAGE_CAPTURE_REQUEST = 1;
    static final int IMAGE_PICK_REQUEST = 2;
    private Bitmap bitmap = null;
    private PuzzleBoardView5 puzzleBoardView;
    ...
    private static PuzzleImageGame5x5 puzzleImageGame5x5 = null;

    public PuzzleImageGame5x5() {
        puzzleImageGame5x5 = this;
    }

    public static PuzzleImageGame5x5 getPuzzleImageGame5x5() {
        return puzzleImageGame5x5;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_5x5);
        ...
        puzzleBoardView = new PuzzleBoardView5(this);
        ...
        shuffleIB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MediaPlayer mediaPlayer = MediaPlayer.create(PuzzleImageGame5x5.this, R.raw.card_shuffle);
                mediaPlayer.start();
    ...
    public void winningAlertDialog(){
        ...
        MediaPlayer mediaPlayer = MediaPlayer.create(PuzzleImageGame5x5.this,R.raw.applause3);
        mediaPlayer.start();

        movesCount = puzzleBoardView.movesCount;
        AlertDialog.Builder builder = new AlertDialog.Builder(PuzzleImageGame5x5.this);
        ...
        builder.setView(dialogView)
                .setNeutralButton(R.string.save_score, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        startActivity(new Intent(PuzzleImageGame5x5.this, MediumModeHighScores.class));
